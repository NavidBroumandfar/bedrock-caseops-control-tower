...
The first local downstream workflow after intake creates a deterministic case work item from `IntakeResult`; see [docs/case-work-item-workflow.md](docs/case-work-item-workflow.md). The next local packet-building step creates a supervisor-ready case brief; see [docs/case-brief-workflow.md](docs/case-brief-workflow.md).
